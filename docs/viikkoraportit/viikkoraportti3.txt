...
Keskiviikko 4h, suunnittelin Trie-rakennetta ja jäsentelin tiedostoja sekä aloitin hieman Trie-rakenteen funktioita. Edellisestä markov_model.py:stä tuli train.py.
Lisäksi valmistelin käyttöliittymän pohjaa.
